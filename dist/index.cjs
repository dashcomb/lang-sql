...
const parser$1 = lr.LRParser.deserialize({
  version: 14,
  states: "%WQ]QROOO!mQRO'#DTO$ZQQO'#CwO%sQRO'#CyO%zQRO'#CzO&RQRO'#C{OOQQ'#DT'#DTOOQQ'#DO'#DOO&YQRO'#C|OOQQ'#Cu'#CuOOQQ'#C}'#C}Q]QROOQOQQOOO&dQQO'#DPO&oQRO,59cO(]QQO,59cOOQQ,59e,59eO(bQRO,59eOOQQ,59f,59fO(iQRO,59fOOQQ,59g,59gO(pQRO,59gOOQQ-E6|-E6|OOQQ,59a,59aOOQQ-E6{-E6{OOQQ,59k,59kOOQQ-E6}-E6}O(wQRO1G.}OOQQ1G/P1G/POOQQ1G/Q1G/QOOQQ1G/R1G/RP*eQRO'#DO",
  stateData: "*l~OuOSPOSQOS~ORUOSUOTUOUROWSOYTO[XO]QO^UO_UO`POaPObPOcUOdUOeUOfUOgUOjUOlUO~O]]ORwXSwXTwXUwXWwXYwX[wX^wX_wX`wXawXbwXcwXdwXewXfwXgwXjwXlwXtwXVwXXwXZwX~O`_Oa_Ob_O~ORUOSUOTUOUROWSOYTO]QO^UO_UO`POaPObPOcUOdUOeUOfUOgUOjUOlUO~OV`O~P$fOXbO~P$fOZdO~P$fO[gOtpX~P$fO`iOaiObiO~O]]ORkaSkaTkaUkaWkaYka[ka^ka_ka`kaakabkackadkaekafkagkajkalkatkaVkaXkaZka~O]]O~OVlO~P$fOXmO~P$fOZnO~P$fO]]ORkiSkiTkiUkiWkiYki[ki^ki_ki`kiakibkickidkiekifkigkijkilkitkiVkiXkiZki~O[gO~P$fO",
  goto: "#axPPPPPPPPPPPPPPPPPPPPPPPPPyP}P}}}!Z!_!e!yPPP#TTYOZeUORSTWZaceoT[OZQZORhZSWOZQaRQcSQeTZfWaceoQ^PSj^kRk_eVORSTWZaceo",
  nodeNames: "⚠ LineComment BlockComment Number Bool Null ( ) [ ] { } ; . Operator Punctuation SpecialVar Identifier QuotedIdentifier Keyword Type Bits Bytes Builtin Script Statement String CompositeIdentifier JsTag Parens Braces Brackets Statement",
  maxTerm: 39,
  skippedNodes: [0,1,2],
  repeatNodeCount: 3,
  tokenData: "%p~RRrs[wx#S#o#p$u~aWj~OY[Zr[rsys#O[#O#P!O#P;'S[;'S;=`!|<%lO[~!OOj~~!RRO;'S[;'S;=`![;=`O[~!aXj~OY[Zr[rsys#O[#O#P!O#P;'S[;'S;=`!|;=`<%l[<%lO[~#PP;=`<%l[~#XWj~OY#SZw#Swxyx#O#S#O#P#q#P;'S#S;'S;=`$o<%lO#S~#tRO;'S#S;'S;=`#};=`O#S~$SXj~OY#SZw#Swxyx#O#S#O#P#q#P;'S#S;'S;=`$o;=`<%l#S<%lO#S~$rP;=`<%l#S~$xP#o#p${~%OTO#q${#q#r%_#r;'S${;'S;=`%j<%lO${~%bP#q#r%e~%jOl~~%mP;=`<%l${",
  tokenizers: [0, tokens],
  topRules: {"Script":[0,24]},
  tokenPrec: 0
});
