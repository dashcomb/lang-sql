...
var langJs = require('@codemirror/lang-js');
...
const parser$1 = lr.LRParser.deserialize({
  version: 14,
  states: "%|Q]QTOOO!mQTO'#DXO$ZQSO'#CwO$fQUO'#CzO%{QTO'#C|O&SQTO'#C}O&ZQTO'#DOOOQS'#DX'#DXOOQS'#DR'#DRO&bQTO'#DPOOQS'#Cv'#CvOOQS'#DQ'#DQQ]QTOOQOQSOOO&lQSO'#DSO&wQTO,59cO(eQSO,59cOOQS'#DT'#DTO(jQUO,59fOOQS,59f,59fOOQS,59h,59hO(rQTO,59hOOQS,59i,59iO(yQTO,59iOOQS,59j,59jO)QQTO,59jOOQS-E7P-E7POOQS,59b,59bOOQS-E7O-E7OOOQS,59n,59nOOQS-E7Q-E7QO)XQTO1G.}OOQS-E7R-E7ROOQS1G/Q1G/QOOQS1G/S1G/SOOQS1G/T1G/TOOQS1G/U1G/UP*uQTO'#DR",
  stateData: "*|~OyOSPOSQOS~ORVOSVOTVOUVOVSOXTOZUO]YO^QO_VO`VOaPObPOcPOdVOeVOfVOgVOhVOmRO~O^^OR{XS{XT{XU{XV{XX{XZ{X]{X_{X`{Xa{Xb{Xc{Xd{Xe{Xf{Xg{Xh{Xm{Xx{XW{XY{X[{X~Oa`Ob`Oc`O~OlcOoaO~ORVOSVOTVOUVOVSOXTOZUO^QO_VO`VOaPObPOcPOdVOeVOfVOgVOhVOmRO~OWdO~P$nOYfO~P$nO[hO~P$nO]kOxsX~P$nOamObmOcmO~O^^ORkaSkaTkaUkaVkaXkaZka]ka_ka`kaakabkackadkaekafkagkahkamkaxkaWkaYka[ka~O^^O~OlqOoaO~OWrO~P$nOYsO~P$nO[tO~P$nO^^ORkiSkiTkiUkiVkiXkiZki]ki_ki`kiakibkickidkiekifkigkihkimkixkiWkiYki[ki~O]kO~P$nO",
  goto: "#k|PPPPPPPPPPPPPPPPPPPPPPPPPP}!RPP!RP!R!R!R!_!c!i!}#XPPP#_TZO[eVOSTUX[egiuT]O[Q[ORl[SXO[QeSQgTQiUZjXegiuQ_PSn_oRo`QbRRpbeWOSTUX[egiu",
  nodeNames: "⚠ LineComment BlockComment String Number Bool Null ( ) [ ] { } ; . Operator Punctuation SpecialVar Identifier QuotedIdentifier Keyword Type Bits Bytes Builtin Script Statement CompositeIdentifier EndJsTag StartJsTag JsTag JsText Parens Braces Brackets Statement",
  maxTerm: 43,
  nodeProps: [
    ["openedBy", 28,"StartJsTag"],
    ["closedBy", 29,"EndJsTag"]
  ],
  skippedNodes: [0,1,2],
  repeatNodeCount: 4,
  tokenData: "#W~RVO#oh#o#p!P#p#qh#q#r!{#r;'Sh;'S;=`y<%lOhQmSoQO#qh#r;'Sh;'S;=`y<%lOhQ|P;=`<%lhR!UUoQO#oh#o#p!h#p#qh#r;'Sh;'S;=`y<%lOhR!oSoQmPO#qh#r;'Sh;'S;=`y<%lOh~#OP#q#r#R~#WOl~",
  tokenizers: [0, 1, tokens],
...
function completeKeywords(keywords, upperCase) {
    ...
    return autocomplete.ifNotIn(["QuotedIdentifier", "SpecialVar", "String", "LineComment", "BlockComment", ".", "JsTag"], autocomplete.completeFromList(completions));
}
