...
import { parser as parser$3 } from '@lezer/javascript';
...
const parser$1 = /*@__PURE__*/LRParser.deserialize({
  version: 14,
  states: "%|Q]QTOOO!mQUO'#CwO!uQTO'#DVO$cQSO'#CyO%{QTO'#CzO&SQTO'#C{O&ZQTO'#C|OOQS'#DV'#DVOOQS'#DP'#DPO&bQTO'#C}OOQS'#Cv'#CvOOQS'#DO'#DOQ]QTOOQOQSOOOOQS'#DQ'#DQO&lQUO,59cOOQS,59c,59cO&tQSO'#DRO'PQTO,59eO(mQSO,59eOOQS,59f,59fO(rQTO,59fOOQS,59g,59gO(yQTO,59gOOQS,59h,59hO)QQTO,59hOOQS-E6}-E6}OOQS,59b,59bOOQS-E6|-E6|OOQS-E7O-E7OOOQS1G.}1G.}OOQS,59m,59mOOQS-E7P-E7PO)XQTO1G/POOQS1G/Q1G/QOOQS1G/R1G/ROOQS1G/S1G/SP*uQTO'#DP",
  stateData: "*|~OwOSPOSQOS~ORVOSVOTVOUVOVSOXTOZUO]YO^RO_VO`VOaQObQOcQOdVOeVOfVOgVOhVO{PO~Ol^Oz`O~O^aORyXSyXTyXUyXVyXXyXZyX]yX_yX`yXayXbyXcyXdyXeyXfyXgyXhyXvyX{yXWyXYyX[yX~OacObcOccO~ORVOSVOTVOUVOVSOXTOZUO^RO_VO`VOaQObQOcQOdVOeVOfVOgVOhVO{PO~OWdO~P$nOYfO~P$nO[hO~P$nO]kOvqX~P$nOl^OznO~OaoOboOcoO~O^aORmaSmaTmaUmaVmaXmaZma]ma_ma`maamabmacmadmaemafmagmahmavma{maWmaYma[ma~O^aO~OWrO~P$nOYsO~P$nO[tO~P$nO^aORmiSmiTmiUmiVmiXmiZmi]mi_mi`miamibmicmidmiemifmigmihmivmi{miWmiYmi[mi~O]kO~P$nO",
  goto: "#izPPPPPPPPPPPPPPPPPPPPPPPPPP{!PP!P!P!P!P!]!a!g!{#RPPP#]TZO[eVOSTUX[egiuT]O[Q[ORl[SXO[QeSQgTQiUZjXegiuQ_PRm_QbQSpbqRqceWOSTUX[egiu",
  nodeNames: "⚠ LineComment BlockComment String Number Bool Null ( ) [ ] { } ; . Operator Punctuation SpecialVar Identifier QuotedIdentifier Keyword Type Bits Bytes Builtin Script Statement JsTag JsText CompositeIdentifier Parens Braces Brackets Statement",
  maxTerm: 43,
  skippedNodes: [0,1,2],
  repeatNodeCount: 4,
  tokenData: "#W~RVO#oh#o#p!P#p#qh#q#r!{#r;'Sh;'S;=`y<%lOhQmSlQO#qh#r;'Sh;'S;=`y<%lOhQ|P;=`<%lhR!UUlQO#oh#o#p!h#p#qh#r;'Sh;'S;=`y<%lOhR!oS{PlQO#qh#r;'Sh;'S;=`y<%lOh~#OP#q#r#R~#WOz~",
