...
import { parser as parser$2 } from '@codemirror/lang-js';
...
function completeKeywords(keywords, upperCase) {
    ...
    return ifNotIn(["QuotedIdentifier", "SpecialVar", "String", "LineComment", "BlockComment", ".", "JsTag"], completeFromList(completions));
}
